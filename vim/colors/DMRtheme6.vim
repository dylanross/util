...
set t_Co=256
let colors_name = "DMRtheme6"

hi Comment	    guifg=#71a8a1    ctermfg=242    gui=bold    cterm=bold 
hi Constant	    guifg=#ffaa00    ctermfg=214    gui=none    cterm=none 
...
hi Identifier	    guifg=#93a2d9    ctermfg=245    gui=none    cterm=none 
hi LineNr	    guifg=#8c8c8c    ctermfg=245    gui=none    cterm=none 
hi MatchParen	    guifg=#ccffcc    ctermfg=252    guibg=#008b8b    ctermbg=33    gui=none    cterm=none 
hi Normal	    guifg=#e6e6e6    ctermfg=254    guibg=#342f40    ctermbg=237    gui=none    cterm=none 
...
hi PreProc	    guifg=#f27474    ctermfg=255    gui=none    cterm=none 
hi Statement	    guifg=#e69045    ctermfg=254    gui=bold    cterm=bold 
...
hi String	    guifg=#ffabab    ctermfg=214    gui=none    cterm=none 
